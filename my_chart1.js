...
const Eau = document.getElementById("myEau").getContext("2d");
const myEau = new Chart(Eau, {
  type: "bar",
...
chartSelect.addEventListener("change", (e) => {
  myEau.config.type = e.target.value;
  myEau.update();
  console.log(myEau);
});
...
intervals.forEach((interval) => {
  interval.addEventListener("click", (e) => {
    ...
    if (e.target.innerHTML === "Journée") {
      myEau.data.labels = ["00:00", "01:00", "02:00","03:00","04:00","05:00", "06:00","07:00","08:00", "09:00","10:00", "11:00", "12:00","13:00","14:00","15:00", "16:00","17:00","18:00", "19:00","20:00","21:00", "22:00","23:00"];
      myEau.data.datasets[0].data = [
        randomint(0, 30),
        randomint(0, 30),
        randomint(0, 30),
        randomint(0, 30),
      ...
      myEau.data.labels = ["Lun", "Mar", "Mer", "Je", "Ven", "Sam", "Dim"];
      myEau.data.datasets[0].data = [
        randomint(0, 30),
        randomint(0, 30),
        randomint(0, 30),
